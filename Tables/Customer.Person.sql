...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Person__Modified__37A5467C] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Person] ADD CONSTRAINT [PK__Person__543B4487D4744529] PRIMARY KEY CLUSTERED  ([person_ID]) ON [PRIMARY]
GO
